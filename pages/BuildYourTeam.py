...
def main():
    ...
    naive_deadline = datetime.datetime(2026, 3, 17, 11, 0)
...
def rules_tab():
    ...
    3. **Submit Your Team**:
       - Enter your team name, submit, and good luck! Note that the entry fee is $30 and will be collected via Venmo (@masonbikshorn).
    4. **Key Dates**:
        - Selection Sunday: 3/15
        - First Four/Play-in Games: 3/17 - 3/18
