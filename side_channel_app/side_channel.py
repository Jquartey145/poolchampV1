...
ODDS_API_KEY = '4fa3622c0f8a6b4c9b72adfe2dbb8ad2'
...
def fetch_player_stats(api_key, season):
    """Fetch player stats for a given season."""
    url = f'https://api.sportsdata.io/v4/basketball_ncaab/stats/json/PlayerSeasonStats/{season}'
